...
export default function PrefecturesPage() {
  ...
  return <section className="page page--discovery"><PageHero eyebrow="Forty-seven stories" title="Japan’s prefectures" subtitle="Search and compare every prefecture by region, rating, and community contributions." />
