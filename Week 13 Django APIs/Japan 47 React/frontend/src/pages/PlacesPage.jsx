...
export default function PlacesPage() {
  ...
  return <section className="page page--discovery"><PageHero eyebrow="Community guide" title="Places to discover" subtitle="Browse destinations shared by Japan 47 contributors."><Link className="button button--primary" to="/places/new">Suggest a place</Link></PageHero>
